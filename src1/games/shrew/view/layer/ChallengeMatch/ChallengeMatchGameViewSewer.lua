...
local ChallengeMatchGameViewSewer = class("ChallengeMatchGameViewSewer",shrew.view.ChallengeMatchGameView)

function ChallengeMatchGameViewSewer:ctor()

    ChallengeMatchGameViewSewer.super.ctor(self)
    self:init()
end

function ChallengeMatchGameViewSewer:init()

    ChallengeMatchGameViewSewer.super.init(self)
...
function ChallengeMatchGameViewSewer:onExit()

    ChallengeMatchGameViewSewer.super.onExit(self)
...
function ChallengeMatchGameViewSewer:setScene()
...
function ChallengeMatchGameViewSewer:showBubble1()
...
function ChallengeMatchGameViewSewer:showBubble2()
...
function ChallengeMatchGameViewSewer:bubble_callBack1()
...
function ChallengeMatchGameViewSewer:bubble_callBack2()

    self._bg:removeChildByTag(22)
    self:showBubble2()
    
end
return ChallengeMatchGameViewSewer