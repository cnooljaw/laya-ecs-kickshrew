...
local ChallengeMatchGameViewShip = class("ChallengeMatchGameViewShip",shrew.view.ChallengeMatchGameView)

function ChallengeMatchGameViewShip:ctor()

    ChallengeMatchGameViewShip.super.ctor(self)
    
    self:init()
end

function ChallengeMatchGameViewShip:init()

    ChallengeMatchGameViewShip.super.init(self)
...
function ChallengeMatchGameViewShip:onExit()

    ChallengeMatchGameViewShip.super.onExit(self)
...
function ChallengeMatchGameViewShip:setScene()
...
--[[
--]]
function ChallengeMatchGameViewShip:doChangeScene()

   

end

return ChallengeMatchGameViewShip