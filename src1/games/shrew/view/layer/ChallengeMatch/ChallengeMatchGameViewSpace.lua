...
local ChallengeMatchGameViewSpace = class("ChallengeMatchGameViewSpace",shrew.view.ChallengeMatchGameView)

function ChallengeMatchGameViewSpace:ctor()

    ChallengeMatchGameViewSpace.super.ctor(self)
    
    self:init()
end

function ChallengeMatchGameViewSpace:init()

    ChallengeMatchGameViewSpace.super.init(self)
...
function ChallengeMatchGameViewSpace:onExit()

    ChallengeMatchGameViewSpace.super.onExit(self)
...
function ChallengeMatchGameViewSpace:setScene()
...
土星动画
--]]
function ChallengeMatchGameViewSpace:doRoate()
...
return ChallengeMatchGameViewSpace