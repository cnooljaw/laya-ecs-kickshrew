...
local GameViewGrass = class("GameViewGrass",shrew.view.GameView)

function GameViewGrass:ctor()

    GameViewGrass.super.ctor(self)
    self:init()
end

function GameViewGrass:init()

    GameViewGrass.super.init(self)
...
function GameViewGrass:onExit()

    GameViewGrass.super.onExit(self)
...
function GameViewGrass:setScene()
...
--[[
--]]
function GameViewGrass:doChangeScene()
