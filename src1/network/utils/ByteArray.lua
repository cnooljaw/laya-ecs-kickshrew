...
function ByteArray:readBytes(__bytes, __offset, __length)
	...
	--local __availableLen = __selfLen - self._pos --old is this
	local __availableLen = self:getAvailable() --fix by jaw
	__offset = __offset or 1
	...
	--for i=__offset,__offset+__length do --old is this
	for i=__offset,__length do --fix by jaw
