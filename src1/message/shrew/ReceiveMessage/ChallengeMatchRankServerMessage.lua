...
local ChallengeMatchRankServerMessage = class("ChallengeMatchRankServerMessage",ReceiveMessage)


function ChallengeMatchRankServerMessage:unPackRank()
    local rank = {}
...
function ChallengeMatchRankServerMessage:unPackMessage()
    self._rankList = {}
    for i = 1, 10 do
...
return ChallengeMatchRankServerMessage