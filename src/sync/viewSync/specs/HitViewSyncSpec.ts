...
const syncRow = createSyncRow<IHitEffectNode, HitField>();
...
export const HIT_VIEW_SYNC_SPEC = defineViewSyncSpec<IHitEffectNode, HitField>(
  "HitComponent",
  HitComponent,
  [
    // bit             label          fields         apply
    syncRow(BIT_HIT_INDEX,  "命中地鼠索引", ["shrewIndex"], applyHitEffect),
    syncRow(BIT_HIT_REWARD, "命中奖励",     ["reward"],     applyHitEffect),
    syncRow(BIT_HIT_WASHIT, "是否命中",     ["wasHit"],     applyHitEffect),
  ],
);
